...
public class SQLGenerator {
	...
	// A map of table answer variables and respective table columns in order of output class descriptions variable order
	public static Map<String, String> ansVar2tableColumn = new LinkedHashMap<String, String>();
	// table columns in order of output class descriptions variable order
	public static List<String> tableColumns = new ArrayList<String>(); 
	...
	for (InputSyntax.Literal lit : Ea)
		...
		System.out.println("answer variable : " +answerVar + " dbColName : " +attributeForYVar(yVar));
		ansVar2tableColumn.put(answerVar, attributeForYVar(yVar));
		tableColumns.add(attributeForYVar(yVar));
