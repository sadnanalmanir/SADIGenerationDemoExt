...
public class Config extends ca.wilkinsonlab.sadi.Config
{
	...
	protected static final String DEFAULT_PROPERTIES_FILENAME = "sadi.share.properties"; // cardioSHARE default properties
	protected static final String LOCAL_PROPERTIES_FILENAME = "sadi.properties"; // cardioSHARE Properties
