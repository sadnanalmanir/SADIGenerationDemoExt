...
//		reasoningModel.close();
	...
	private Collection<ServiceInputPair> findSubjects(PotentialValues subjects, Collection<OntProperty> properties, PotentialValues objects)
	{
		...
		log.info(String.format("dynamically discovering potential subjects for %s", properties));
		...
		for (Service service: services) {
			...
			log.info(String.format("found service %s with %d inputs", service, inputInstances.size()));
