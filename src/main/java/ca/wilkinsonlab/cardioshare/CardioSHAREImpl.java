...
public class CardioSHAREImpl //extends HttpServlet
{
    ...
    public void runCardioSHARE(HttpServletRequest request, HttpServletResponse response) throws  IOException
    {
