 ...
 */
@Path("/loaddomainont")
public class DomainOntologyLoader {

    private static int INDENT = 4;
    Logger logger = Logger.getLogger(DomainOntologyLoader.class);
    @Context
    UriInfo info;
    ...
    @Encoded
    public String loadDomainOntology(URILoadRequest uriLoadRequest) throws OWLOntologyCreationException, OWLException,
            InstantiationException, IllegalAccessException,
            ClassNotFoundException, UnsupportedEncodingException, URISyntaxException, MalformedURLException {

        logger.info("Loading Domain Ontology...");
