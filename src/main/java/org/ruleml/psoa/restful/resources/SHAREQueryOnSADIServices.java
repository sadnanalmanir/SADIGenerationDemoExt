...
import org.ruleml.psoa.restful.models.SPARQLQueryRequest;
...
public class SHAREQueryOnSADIServices {
    ...
    public SHAREQueryOnSADIServices(){
    ...
    public static String startSHARE(SPARQLQueryRequest request) {
        OntDocumentManager.getInstance().setCacheModels(true);

        String query = decode(request.getQuery());
